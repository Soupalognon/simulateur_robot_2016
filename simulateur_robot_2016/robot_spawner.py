...
# """This process simply sends information to the Spawner through a service."""
...
#         print('WARNING: the Ros2Supervisor was not able to spawn this robot.')
#     return


# class PROTOSpawner(ExecuteProcess):
#     def __init__(self, output='log', name=None,
#                  translation='0 0 0', rotation='0 0 1 0', **kwargs):
